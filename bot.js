...
const discord_token = "NTM5Mzg1MDAwMTYwOTE5NTUz.DzParg.lZdFR7yTrxB3ZzsJhWMqCYPCnok";
...
client.on("message", message => {
 if (message.content === "-support") {
  const embed = new Discord.RichEmbed()
      .setTitle('Click here')
      .setURL(' https://discord.gg/RbdmXEk ')
      .setColor("RANDOM")
      .setFooter('© Premium Bot :heart: جميع الحقوق محفوظة 2018 لــبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/RbdmXEk  `)
  message.author.send({embed});
